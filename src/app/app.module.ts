...
import {CONDITIONAL_DEMO_PROVIDERS} from './core/demo/conditional-demo-provider';
...
@NgModule({
  ...
  imports: [
    ...
    ServiceWorkerModule.register('ngsw-worker.js', {enabled: environment.production && !environment.demo}),
